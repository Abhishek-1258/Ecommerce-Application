...
public class ProductService {
	...
	public ResponseEntity<String> updateProduct(ProductUpdateDTO productDTO) {
		Product product = productRepository.findById(productDTO.getId()).orElseThrow(() -> new ProductNotFoundException("Product with id : " + productDTO.getCategoryId() + " was not found"));
		Category category = categoryRepository.findById(productDTO.getCategoryId())
				.orElseThrow(() -> new CategoryNotFoundException("Category not found with id: " + productDTO.getCategoryId()));
